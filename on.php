...
function show_alert()
{
alert("Enformatik Bölümü ENF-1 Laboratuvarı \nÖğrenci bilgisayarlarının internet bağlantısı AKTİF edilmiştir. \n\nProblem halinde bildiriniz (fatih.ertam@firat.edu.tr)");
window.close()
}
</script>
<style type="text/css">
...
fwrite($fp, "" . $fline . " | " . $theirip .  " AÇILDI\n");
fclose($fp);
...
// switch port enable command ex: set port enable ge.1.1-48
if ($result == 0) {
$telnet->DoCommand('set port enable ge.1.1-48', $result);
